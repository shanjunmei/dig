...
func InitAppEdge(cfg *common.Config, log *logger.Logger) func(context.Context) error {
	...
	if err != nil {
		Logf("[PROVIDE] failed: %s: %v\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_1", err)
		panic(err)
	}
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_1")
	Logf("[SUPPLY] before: %s\n", "int")
	...
	if err != nil {
		Logf("[PROVIDE] failed: %s: %v\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_3", err)
		panic(err)
	}
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_3")
	Logf("[PROVIDE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_4")
	dv13, err := dig_provider_4()
	if err != nil {
		Logf("[PROVIDE] failed: %s: %v\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_4", err)
		panic(err)
	}
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_4")
	Logf("[PROVIDE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_5")
	dv14 := dig_provider_5()
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_5")
	Logf("[PROVIDE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_6")
	dv15 := dig_provider_6()
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_6")
	Logf("[PROVIDE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_7")
	dv16 := dig_provider_7()
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_7")
	Logf("[PROVIDE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_10")
	dv17 := func() common.Config {
		return common.Config{Addr: "127.0.0.1", Port: 9000}
	}()
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_10")
	Logf("[PROVIDE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_12")
	dv18 := dig_provider_12()
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_12")
	Logf("[PROVIDE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_14")
	dv19 := func() *db.DB {
	...
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/role.NewServer")
	Logf("[PROVIDE] identity conversion: %s -> %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_8", "db.Pinger")
	dv21 := db.Pinger(dv12)
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_8")
	Logf("[PROVIDE] identity conversion: %s -> %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_9", "any")
	dv22 := any(dv12)
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_9")
	Logf("[PROVIDE] identity conversion: %s -> %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_11", "*common.Config")
	dv23 := &dv17
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_11")
	Logf("[PROVIDE] identity conversion: %s -> %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_13", "db.DB")
	dv24 := *dv18
	Logf("[PROVIDE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_provider_13")
	return func(ctx context.Context) error {
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_1")
		...
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/user.ProcessStore")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_2")
		dig_invoke_2(dv6)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_2")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_3")
		func(cfg role.Config) {
			fmt.Printf("Config supplied: %s\n", cfg)
		}(dv7)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_3")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_4")
		func(s *role.Server) {
			s.Run()
		}(dv20)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_4")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_5")
		dig_invoke_5(dv8, dv9)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_5")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_6")
		dig_invoke_6(dv12, dv14, dv11)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_6")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_7")
		func(replicaDB *db.DB, sessionRedis *db.RedisClient) {
			fmt.Printf("Replica: %s, Session: %s\n", replicaDB.Name, sessionRedis.Name)
		}(dv13, dv15)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_7")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_8")
		dig_invoke_8(dv12, dv14, dv11)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_8")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_9")
		dig_invoke_9(dv21, dv22, dv23, dv24, dv18)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_9")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_10")
		...
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_10")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_11")
		func(s *user.Store[string]) {
			setup.BootstrapStore(s)
		}(dv16)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_11")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_12")
		func(defaultDB *db.DB, primaryDB *db.DB, log *logger.Logger) {
			log.Println("Edge: default DB =", defaultDB.Name, ", primary DB =", primaryDB.Name)
		}(dv19, dv12, dv1)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_12")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_13")
		dig_invoke_13(dv8, dv1)
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_13")
		Logf("[INVOKE] before: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_14")
		if err := dig_invoke_14(dv0, dv1); err != nil {
			Logf("[INVOKE] failed: %s: %v\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_14", err)
			return err
		}
		Logf("[INVOKE] after: %s\n", "github.com/shanjunmei/dig/example/app_edge.dig_invoke_14")
		return nil
