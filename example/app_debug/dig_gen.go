...
// closure defined at example/app_debug/di.go:26
...
// closure defined at example/app_debug/di.go:31
...
func InitAppDebug(cfg *common.Config, log *logger.Logger) func(context.Context) error {
	...
	// supplied from function 'InitAppDebug' argument 'cfg' (type *github.com/shanjunmei/dig/example/common.Config) at example/app_debug/di.go:20
	v0 := cfg
	Logf("[SUPPLY] after: %s\n", "*github.com/shanjunmei/dig/example/common.Config")
	Logf("[SUPPLY] before: %s\n", "*github.com/shanjunmei/dig/example/internal/logger.Logger")
	// supplied from function 'InitAppDebug' argument 'log' (type *github.com/shanjunmei/dig/example/internal/logger.Logger) at example/app_debug/di.go:20
	v1 := log
	Logf("[SUPPLY] after: %s\n", "*github.com/shanjunmei/dig/example/internal/logger.Logger")
