...
// closure defined at example/app/di.go:33
...
// closure defined at example/app/di.go:38
...
func InitApp(cfg *common.Config, log *logger.Logger) func(context.Context) error {
	...
	// supplied from function 'InitApp' argument 'cfg' (type *github.com/shanjunmei/dig/example/common.Config) at example/app/di.go:27
	v0 := cfg
	Logf("[SUPPLY] after: %s\n", "*github.com/shanjunmei/dig/example/common.Config")
	Logf("[SUPPLY] before: %s\n", "*github.com/shanjunmei/dig/example/internal/logger.Logger")
	// supplied from function 'InitApp' argument 'log' (type *github.com/shanjunmei/dig/example/internal/logger.Logger) at example/app/di.go:27
	v1 := log
	Logf("[SUPPLY] after: %s\n", "*github.com/shanjunmei/dig/example/internal/logger.Logger")
