...
// closure defined at cmd/digen/di.go:29
...
func InitApp(cfg *config.Config) func(context.Context) error {
	...
	// supplied from function 'InitApp' argument 'cfg' (type *github.com/shanjunmei/dig/internal/config.Config) at cmd/digen/di.go:23
	v0 := cfg
	Logf("[SUPPLY] after: %s\n", "*github.com/shanjunmei/dig/internal/config.Config")
	...
	v3 := func(_cfg *config.Config) string {
