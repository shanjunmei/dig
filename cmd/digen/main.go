...
func main() {
	...
	var (
		...
		inline    = fs.Bool("inline", false, "inline simple closures as IIFEs; identity closures are ALWAYS collapsed to a type conversion regardless of this flag")
	...
	fs.Usage = func() {
		...
		fmt.Fprintf(out, "  digen -inline ./...                 # also inline simple closures as IIFEs (identity closures are always collapsed)\n")
